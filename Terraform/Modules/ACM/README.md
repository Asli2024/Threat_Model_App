...
| <a name="input_domain_name"></a> [domain\_name](#input\_domain\_name) | FQDN for the certificate (e.g., threatcomposer.techwithaden.com) | `string` | `""` | no |
| <a name="input_environment"></a> [environment](#input\_environment) | Deployment environment (e.g., dev, staging, prod) | `string` | `""` | no |
| <a name="input_subject_alternative_names"></a> [subject\_alternative\_names](#input\_subject\_alternative\_names) | Optional SANs, e.g., ["www.threatcomposer.techwithaden.com"] | `list(string)` | `[]` | no |
